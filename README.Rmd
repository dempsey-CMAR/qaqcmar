...
Should we add a section or at least mention how this package could be used by other people collecting the same ocean data? And what their data format would have to be to match that? And that they can override the built in thresholds if they want to run these tests on their data with different thresholds? 
